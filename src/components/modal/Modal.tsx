    ...
    <AnimatePresence>
      {isModalOpen && (
        <>
          ...
          <motion.div initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1, transition: { delay: 0.2, duration: 0.2 } }} exit={{ scale: 0 }} className="modal-content-wrapper bg-slate-100 w-[500px] h-[60vh] absolute m-auto top-0 left-0 right-0 bottom-0 z-[999]">
